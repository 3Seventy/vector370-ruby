...
class Campaign < SoftDeletable
  ...
  # @return [Integer] The ID of the subscription that contacts will be opted into.
  attr_accessor :subscription_id
  
  # @return [String] The campaign's name and this is a free form name.
  attr_accessor :name
  ...
  # @return [String] The arbitrary user data field. This an area to store free form data. The Vector Portal uses this field to store some UI hints.
